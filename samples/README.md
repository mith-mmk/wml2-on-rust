...
- `D:\data\samples\images\tiff\alpha-lzw-20260913\`: 29枚。CMYKの非乗算alpha、明示的に未対応として拒否するCMYK乗算済みalpha・Palette alpha、Gray/RGB associated alphaの16/32-bit LE/BE、WhiteIsZero Gray associated alphaの8/16/32-bit部分透明・完全透明を含みます。
