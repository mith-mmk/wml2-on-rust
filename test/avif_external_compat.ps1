...
$manifest = @(
    ...
    [pscustomobject]@{ Name = 'fox.profile2.8bpc.yuv422.avif'; Kind = 'unsupported'; RelativePath = 'avif/unsupported/fox.profile2.8bpc.yuv422.avif'; Sha256 = '2cb363d30f83bff58ee049874b1808b37cb1d35342edf16b3ce25cb243c9ea55'; ErrorPattern = 'chroma subsampling does not match sequence header' }
