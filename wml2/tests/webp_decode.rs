...
fn animated_sample_bytes() -> Vec<u8> {
    vec![
        82, 73, 70, 70, 192, 0, 0, 0, 87, 69, 66, 80, 86, 80, 56, 88, 10, 0, 0, 0, 2, 0, 0, 0,
        3, 0, 0, 3, 0, 0, 65, 78, 73, 77, 6, 0, 0, 0, 255, 255, 255, 255, 1, 0, 65, 78, 77, 70,
        72, 0, 0, 0, 0, 0, 0, 0, 0, 0, 3, 0, 0, 3, 0, 0, 100, 0, 0, 2, 86, 80, 56, 32, 48, 0,
        0, 0, 208, 1, 0, 157, 1, 42, 4, 0, 4, 0, 2, 0, 52, 37, 160, 2, 116, 186, 1, 248, 0, 3,
        176, 0, 254, 240, 232, 247, 255, 32, 185, 97, 117, 200, 215, 255, 32, 63, 227, 42, 124,
        101, 79, 248, 242, 0, 0, 0, 65, 78, 77, 70, 68, 0, 0, 0, 0, 0, 0, 0, 0, 0, 3, 0, 0, 3,
        0, 0, 100, 0, 0, 0, 86, 80, 56, 32, 44, 0, 0, 0, 148, 1, 0, 157, 1, 42, 4, 0, 4, 0, 0,
        0, 52, 37, 160, 2, 116, 186, 0, 3, 152, 0, 254, 249, 147, 111, 255, 144, 31, 255, 144,
        31, 255, 144, 31, 255, 32, 63, 226, 23, 123, 32, 48, 0,
    ]
}
...
fn decode_webp_still_samples_from_file() {
    ...
    for (name, width, height, codec) in cases {
        ...
        assert!(image.buffer.as_ref().map(|buffer| !buffer.is_empty()).unwrap_or(false));
