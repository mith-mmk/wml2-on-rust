...
pub fn gps_mapper(tag :u16, data: &DataPack,length: usize) -> (String,String){
    let tagname;
    let s;
    match tag {
            0x0000 => {
            tagname = "GPSVersionID";
            s = print_data(&data,length);
        },
            0x0001 => {
...
pub fn tag_mapper(tag :u16, data: &DataPack,length: usize) -> (String,String) {
    let tagname;
    let s;
    match tag {
        0x0001 => {
